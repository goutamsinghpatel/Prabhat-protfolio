...
// // 🔐 EmailJS IDs (इनको अपने actual IDs से replace करना है)
...
//     try {
//       // 👇 ये object के keys आपके EmailJS template के variables से match होने चाहिए
//       await emailjs.send(
//         SERVICE_ID,
//         TEMPLATE_ID,
//         {
...
//       setStatus("Thank you! Your booking request has been sent. We'll contact you soon.");
//       setForm({ name: "", mobile: "", message: "" }); // clear form
//     } catch (error) {
//       console.error(error);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        {/* Left: Image + Info cards (form hata diya) */}
        <motion.div className="space-y-6" variants={itemVariants}>
          {/* Image */}
          <motion.div
            whileHover={{ scale: 1.02 }}
